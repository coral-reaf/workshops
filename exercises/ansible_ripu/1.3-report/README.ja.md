...
- Leapp のアップグレード前レポートで報告されたハイリスクの調査結果は、潜在的な障害モードを認知させるためのものですが、経験上、多くの場合は問題にならないことがわかっています。レポートに赤い結果が表示されても、怖がらないことです。やってみて失敗したら元に戻す。まずは、恐れず、早めに頻繁にアップグレードを心がけてください。
